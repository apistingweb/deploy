...
~> Last Updated      : 15 - 11 - 2024   : ->  02:00 AM  +02 GMT
...
function startCountdown() {
        ...
        async function fetchMatches(url) {
            try {
                ...
                document.querySelector("sting-web").innerHTML = `<div class="Error" style="text-align:center; padding:20px; color:red;">حدث خطأ غير متوقع</div>`;
                return [];
            }
        }
        ...
        async function loadMatches() {
            ...
            const url = `https://www.sting-web.com/apis/oo/v2/apps/panel/3in1_ar.json?${label}`;
                           ...
                           <div class="STING-WEB-Match">
                                <a href="${match.link}" title="${match['Team-Right'].Name} vs ${match['Team-Left'].Name}">
                                    <div class="STING-WEB-Top">
                                        ...
                                        <div class="STING-WEB-Center">
                                            ...
                                            <div class="STING-WEB-Match-Bio">
                                                <div class="STING-WEB-TimeZone">بتوقيت جهازك</div>
                                    ...
                                    <div class="STING-WEB-Bottom">
                                        ...
                                        <span class="STING-WEB-Betola Cup">${match.Cup}</span>
                                    </div>
